        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-9 space-x-6">
            ...
            <div className="relative group">
              <button className="flex items-center font-medium text-black hover:text-blue-600">
                Marketplace
                <ChevronDown size={16} className="ml-1" />
              </button>
              <div className="absolute hidden group-hover:block bg-white shadow-lg rounded-md p-4 w-48 mt-2">
                <a href="#" className="block py-2 text-black hover:text-blue-600">Furniture</a>
                <a href="#" className="block py-2 text-black hover:text-blue-600">Decor</a>
                <a href="#" className="block py-2 text-black hover:text-blue-600">Appliances</a>
                <a href="#" className="block py-2 text-black hover:text-blue-600">Services</a>
              </div>
            </div>
            {/* <a href="#" className="font-medium text-black hover:text-blue-600">About Us</a> */}
